...
###################################### moje vlastní aliasy
#alias aram='ssh root@aram-nettop'
alias renata='ssh root@renata-netbook'
# alias kladruby='ssh root@kladruby-desktop'
#alias jindra='ssh root@jindra-desktop'
...
alias up="sudo apt-fast update; sudo apt-fast upgrade -y; apt-get clean; apt-fast autoclean; sudo apt-fast purge ~c"
